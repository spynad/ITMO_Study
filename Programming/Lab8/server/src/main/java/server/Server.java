...
import connection.ConnectionListenerImpl2;
...
public class Server implements Runnable{
    ...
    private final ConnectionListenerImpl2 connectionListener;
    ...
    public Server(ConnectionListenerImpl2 listener, RequestReader reader, RequestHandler handler, ResponseSender sender) throws IOException {
